...
class EasyTaskResult:
    ...
    def __post_init__(self):
        ...
        self.reward = soft_clip(self.reward)
...
class EasyTask:
    ...
    Success   : Graded strictly in (0, 1): 0.99 if classification is correct, 0.01 otherwise (after soft_clip).
    """
    ...
    def run(self, agent_fn, scenario_id: str | None = None) -> EasyTaskResult:
        ...
        Returns:
            EasyTaskResult with score strictly in (0, 1).
        """
        ...
        return EasyTaskResult(
            ...
            score=soft_clip(score),
            steps=steps,
            reward=soft_clip(total_reward),
        )
